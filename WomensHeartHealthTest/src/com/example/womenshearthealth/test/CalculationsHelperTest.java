...
public class CalculationsHelperTest extends TestCase {
	...
	public void testCalculate85HeartRate() {
		...
		age = 100;
		expectedHR = 100;
		calculatedHR = CalculationsHelper.getTargetHeartRateFromAge(age, CalculationsHelper.TARGET_85_PERCENT);
		assertTrue("Age: " + age + "; Expected HR: " + expectedHR + "; Calculated HR: " + calculatedHR + ".",
				calculatedHR == expectedHR);
	...
	public void testCalculate50HeartRate() {
		...
		age = 100;
		expectedHR = 59;
		calculatedHR = CalculationsHelper.getTargetHeartRateFromAge(age, CalculationsHelper.TARGET_50_PERCENT);
		assertTrue("Age: " + age + "; Expected HR: " + expectedHR + "; Calculated HR: " + calculatedHR + ".",
				calculatedHR == expectedHR);
